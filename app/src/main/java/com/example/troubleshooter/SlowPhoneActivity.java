...
public class SlowPhoneActivity extends AppCompatActivity {
    ...
    public static final int NUMBER_OF_IMAGES = 2;
    ...
    public void changeImage() {
        ...
        switch (imageCount) {
            ...
            case 1:
                ...
                stepCounterText.setText("Step 1.1");
                break;

            case 2:
                myImage.setImageResource(R.drawable.slow_phone_02);
                stepCounterText.setText("Step 1.2");
                break;
        }
    }
